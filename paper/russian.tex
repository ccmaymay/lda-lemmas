...
corpus as a preprocessing step and instead to stem the top-$m$ word
lists (as a postprocessing step) as
...
context, otherwise stemming as a \emph{postprocessing} step as
