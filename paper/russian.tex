...
whole documents are displayed in Table~\ref{tab:topics}.
...
\begin{table}
    \begin{tabular}{rrr|rr|r}
        ...
        unfilt & sym         & whole          &          0.54 &          0.52 &          0.61 \\
        \textbf{filt} & \textbf{asym} & \textbf{whole} & \textbf{0.50} & \textbf{0.65} & \textbf{0.02} \\
    ...
    \caption{Detection rate ($\DR$) for the non-lemmatized (non) and
        ...
        trunc and whole indicate whether the documents are truncated.)
