...
Though informally discussed in many
studies~\cite{deerwester1990,hofmann1999,mei2007,nallapati2008,lin2009},
the role of morphology in topic modeling has not been directly
explored.

authors' knowledge the only topic model that even implicitly addresses
also the infinite-vocabulary LDA model~\cite{zhai2013}, in
which a variant of a character n-gram model is used as a prior on
words.
restaurant process prior is
