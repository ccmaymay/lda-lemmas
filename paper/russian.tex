...
symmetric prior.
We also find that short (length-truncated documents) exhibit lower
performance overall and are benefitted less by lemmatization.
%This
...
stop words despite the first topic receiving half of the probability
mass under the prior.  Indeed, many topics consist primarily of stop
