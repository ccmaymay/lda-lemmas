...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Examples of word intrusion interface.}
...
high-frequency words reappear in this projection, we remov any
...
Uniform priors with $\eta_{\cdot} = 0.1$ and
$\alpha_{\cdot} = 5 / K$ were given to models on
filtered vocabularies; non-uniform priors with
$\eta_{\cdot} = 0.1$, $\alpha_1 = 5$, and $\alpha_k = 5 / (K-1)$
for $k > 1$
