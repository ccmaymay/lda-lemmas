...
library(shades)
main_color <- '#7a378b'
high_color <- saturation(brightness(main_color, 1.), delta(-0.3))
low_color <- saturation(brightness(main_color, 0.2), delta(-0.3))
```
...
```{r}
t.test(
  (data %>% filter(language == 'en', lemmatization_1 == 'treetagger', lemmatization_2 == 'treetagger'))$score,
  (data %>% filter(language == 'en', lemmatization_1 == 'none', lemmatization_2 == 'none'))$score,
  alternative='greater'
)
t.test(
  (data %>% filter(language == 'en', lemmatization_1 == 'udpipe', lemmatization_2 == 'udpipe'))$score,
  (data %>% filter(language == 'en', lemmatization_1 == 'none', lemmatization_2 == 'none'))$score,
  alternative='greater'
)
t.test(
  (data %>% filter(language == 'fa', lemmatization_1 == 'treetagger', lemmatization_2 == 'treetagger'))$score,
  (data %>% filter(language == 'fa', lemmatization_1 == 'none', lemmatization_2 == 'none'))$score,
  alternative='greater'
)
t.test(
...
t.test(
  (data %>% filter(language == 'ko', lemmatization_1 == 'treetagger', lemmatization_2 == 'treetagger'))$score,
...
t.test(
  (data %>% filter(language == 'ru', lemmatization_1 == 'treetagger', lemmatization_2 == 'treetagger'))$score,
  (data %>% filter(language == 'ru', lemmatization_1 == 'none', lemmatization_2 == 'none'))$score,
  alternative='greater'
)
t.test(
  (data %>% filter(language == 'ru', lemmatization_1 == 'udpipe', lemmatization_2 == 'udpipe'))$score,
  (data %>% filter(language == 'ru', lemmatization_1 == 'none', lemmatization_2 == 'none'))$score,
  alternative='greater'
)
```
